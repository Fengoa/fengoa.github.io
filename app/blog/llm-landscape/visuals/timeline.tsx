...
const NODES: Node[] = [
  ...
  },
  {
    ...
    desc: "1750 亿参数，prompt 里放入几个例子模型就能照做。Scaling 这件事第一次出现了清晰可辨的拐点。",
    impact: 3,
  },
  {
    year: 2020,
  ...
  },
  {
    ...
    desc: "将人类偏好通过 PPO 注入模型。ChatGPT 的核心做法，对齐从此进入主流词汇。",
    impact: 3,
  },
  {
    year: 2022,
    ...
    desc: "70B 参数训练 1.4T token，效果反超 280B 的 Gopher。GPT-3 之后业界才意识到数据严重不足。",
    impact: 2,
  },
  {
    year: 2023,
    ...
    desc: "7B 到 65B 全系列开源权重，研究者可在自有硬件上部署大模型。",
    impact: 3,
  },
  {
    year: 2023,
  ...
  },
  {
    ...
    desc: "通过分块 + 重计算把 Attention 显存压到线性，速度也提了一倍多。长上下文真正可用，很大程度上靠它。",
    impact: 2,
  },
  {
    year: 2024,
