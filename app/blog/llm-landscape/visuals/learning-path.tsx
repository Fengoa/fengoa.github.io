...
const POSTS: Post[] = [
  ...
  { slug: "llm-rope", no: 7, title: "位置编码 RoPE", short: "RoPE", stage: "arch", col: 4, row: 0, deps: ["llm-transformer"], hint: "用旋转矩阵把位置塞进 Attention，长度外推就靠它。" },
  { slug: "llm-efficient-attention", no: 8, title: "高效注意力", short: "eff. attn", stage: "arch", col: 5, row: 0, deps: ["llm-rope"], hint: "KV Cache、GQA、Flash Attention 把 Attention 在工业上跑得起来。" },
  ...
  { slug: "llm-sft", no: 9, title: "SFT 微调", short: "SFT", stage: "align", col: 6, row: 1, deps: ["llm-training"], hint: "用指令数据让 base 模型学会回答而不是续写，LoRA 让单卡也能微调。" },
