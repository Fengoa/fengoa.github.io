        ...
        <div className="flex justify-center p-4 md:p-12">
          ...
          >
            <Grid.System>
              ...
              >
                {/* 名片：桌面 r1c1，移动 r2c1 */}
                <Grid.Cell row={1} column={1} smRow={2} smColumn={1} className="p-6 md:p-8">
                ...
                {/* 简介：桌面 r2c1，移动 r3c1 */}
                <Grid.Cell row={2} column={1} smRow={3} smColumn={1} className="p-6 md:p-8">
              ...
              <Grid rows={1} columns={2} smColumns={1} smRows={2}>
                <Grid.Cell row={1} column={1} smRow={1} smColumn={1} className="p-6 md:p-8">
                  <div className="flex items-center gap-2 mb-4 text-muted-foreground">
                    <Lightbulb className="size-4" />
                    <span className="text-sm font-medium">产品</span>
                  </div>
                  <div className="space-y-3">
                    <a href="https://moodl.ink" target="_blank" rel="noopener noreferrer" className="block group">
                    ...
                    <a href="https://tradexcellet.com" target="_blank" rel="noopener noreferrer" className="block group">
                ...
                <Grid.Cell row={1} column={2} smRow={2} smColumn={1} className="p-6 md:p-8">
                  <div className="flex items-center gap-2 mb-4 text-muted-foreground">
              ...
              <Grid rows={1} columns={2} smColumns={1} smRows={2}>
                <Grid.Cell row={1} column={1} smRow={1} smColumn={1} className="p-6 md:p-8">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {["React", "TypeScript", "Vue 3", "Next.js", "Node.js", "CSS", "小程序"].map((skill) => (
                      <span key={skill} className="inline-block px-2.5 py-1 text-xs rounded-md bg-muted text-muted-foreground">
                        {skill}
                      </span>
                    ))}
                  </div>
                ...
                <Grid.Cell row={1} column={2} smRow={2} smColumn={1} className="p-6 md:p-8">
                  ...
                  <div className="space-y-3">
                    <a href="https://orienslu.github.io/magic-lottery/zh/" target="_blank" rel="noopener noreferrer" className="block group">
                    ...
                    <a href="https://github.com/logeast/figma-dark-theme" target="_blank" rel="noopener noreferrer" className="block group">
                    ...
                    <a href="https://github.com/WeDaHub/incubator-scan-stars" target="_blank" rel="noopener noreferrer" className="block group">
              ...
              >
                <Grid.Cell row={1} column={1} colSpan={2} smColSpan={1} className="p-6 md:p-8">
                  <div className="flex flex-wrap gap-4 md:gap-6 text-sm">
                    <a href="mailto:oriensx@outlook.com" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
                      <Mail className="size-3.5" />
                      oriensx@outlook.com
                    </a>
                    <a href="https://github.com/orienslu" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
                      <Github className="size-3.5" />
                      oriensx
                    </a>
                    <a href="https://moodl.ink/me" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
                      <Globe className="size-3.5" />
                      moodl.ink/me
                    </a>
                    <a href="/taste" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
