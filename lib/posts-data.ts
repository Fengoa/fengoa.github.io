...
export const postsMeta: PostMeta[] = [
  ...
  { slug: "rec-llm-bridge", title: "推荐系统 × 大模型：四层重叠与五大范式", tag: "推荐系统", date: "2026-02-28" },
  ...
  { slug: "minimal-llm", title: "从零搭一个语言模型", tag: "大模型", date: "2026-03-01" },
  ...
  { slug: "minimal-recommender", title: "从零搭一个推荐系统", tag: "推荐系统", date: "2026-02-01" },
  ...
  { slug: "blog-recommender", title: "纯前端博客推荐系统：TF-IDF + 阅读历史", tag: "建站", date: "2026-01-21" },
  { slug: "craft-oriensx", title: "搭建这个网站", tag: "建站", date: "2026-01-04" },
];
